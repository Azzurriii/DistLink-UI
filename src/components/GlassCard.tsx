...
export default function GlassCard({ title, children }: GlassCardProps) {
  return (
    <div className="relative w-full max-w-md overflow-hidden rounded-[2rem]">
      {/* Background */}
      <div className="absolute inset-0 bg-gray-800/20 backdrop-blur-sm rounded-[2rem]"></div>

      {/* Glow effect */}
      <div className="absolute inset-0 bg-gradient-to-br from-white/5 to-blue-500/5 rounded-[2rem]"></div>
