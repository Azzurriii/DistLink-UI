...
export default function LinksTable() {
  ...
  const links = [
    ...
    {
      shortLink: "https://distlink.com/Bn41aCOinx",
      originalLink: "https://www.telegram.me/distlink",
      clicks: 1423,
      status: "Active",
      date: "Sep - 18 -2023",
    },
                ...
                <div className="p-3 border-t border-gray-700">
                  ...
                  <div className="flex justify-between mb-3">
                    ...
                    <div>
                      ...
                      <div
                        className={`text-sm ${link.status === "Active" ? "text-green-500" : "text-red-500"}`}
                      >
                        {link.status}
                      </div>
                    </div>
                  ...
                  <td className="py-4 px-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center flex-grow mr-2">
                        <PlatformIcon url={link.originalLink} size="sm" />
                        <span className="text-gray-300 truncate max-w-xs ml-2">
                          {link.originalLink}
                        </span>
                      </div>
